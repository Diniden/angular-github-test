...
(function (global) {
    System.config({
        ...
        map: {
            ...
            'app/app.js': 'app.js',
            'app/components/home-view/home-view.js': 'components/app-demo/app-demo.js',
            'app/components/issues-view/issue-view.js': 'components/issues-view/issue-view.js',

            // Util
            'app/util/trim-pipe.js': 'app/util/trim-pipe.js',
            'app/util/is-last.js': 'app/util/is-last.js',

            // Store
            'app/store/app.store.js': 'services/app.service.js',
